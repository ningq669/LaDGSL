...
# Define train, valid, and test main function.
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", "-d", type=str, default="C1/cv_1",
                        help="Dataset string")
    ...
    parser.add_argument("--num_epochs", "-ne", type=int, default=5,
    ...
    parser.add_argument("--attn_rel_emb_dim", "-ar_dim", type=int, default=128,
                        help="Relation embedding size for attention")
    parser.add_argument("--hidden_dim", "-h_dim", type=int, default=128,
                        help="Entity hidden embedding size")
    parser.add_argument("--init_emb_dim", "-dim", type=int, default=64,
