...
# Get train/valid/test splits of the sub-graph defined by the given set of nodes.
...
def main(params):
    ...
    meta_test_nodes = get_subgraph(masked_adj_list, params.hops_test + 1,
                                   params.max_nodes_per_hop_test)
    ...
    print("================")
    train_triplets, valid_triplets, test_triplets, train_active_rels = get_splits(adj_list, meta_train_nodes,
                                                                                  range(len(adj_list)))
    print("================")
    print("Meta-test graph stats")
    print("================")
    meta_train_triplets, meta_valid_triplets, meta_test_triplets, meta_active_rels = get_splits(adj_list,
                                                                                                meta_test_nodes,
                                                                                                train_active_rels)
